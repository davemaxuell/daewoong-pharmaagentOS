...
export default async function EvaluationCenterPage() {
  ...
  try {
    ...
    return <main className={styles.page}><header><span>Evaluation Center</span><h1>Governed evaluation records are unavailable.</h1><p>Confirm the API connection and your evaluation-view permission.</p></header></main>;
  }
